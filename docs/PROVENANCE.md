...
The v1.4.1 improvement bundle applies on top of `e50d83f...` without rewriting prior
...
finite Catalan evidence, and theorem manifest are pinned by Git blob ID in `project.json`.
